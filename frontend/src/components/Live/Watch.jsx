...
const Watch = () => {
  ...
  useEffect(() => {
    const targetDate = new Date('2024-11-20T08:00:00-04:00'); // Target date
    const endDate = new Date('2024-11-24T00:00:00-04:00'); // End date
  ...
  useEffect(() => {
    const fetchLiveVideo = async () => {
      try {
        const channelId = 'UC7rI5BBI5Csd5aIcPdhfTKQ';
    ...
    <div className="relative flex flex-col items-center justify-center p-0 min-h-[600px] md:min-h-[800px] z-0"> {/* Adjusted z-index */}
      ...
      <div className="relative z-10 text-center text-gray-200 flex-grow flex flex-col justify-center w-full h-full">
        {statusMessage ? (
          ...
          <div>
            <h3 className="text-xl mb-2">Camp Meeting is starting in:</h3>

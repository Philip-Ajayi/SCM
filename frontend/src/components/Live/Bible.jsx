  ...
  return (
    <div className="flex flex-col items-center p-6 bg-gray-50 min-h-screen">
      <div className="flex items-center mb-6 w-full">
        ...
        <h1 className="text-4xl font-bold text-blue-800">Bible App</h1>
      </div>
      ...
      <div className="chapter-content w-full max-w-3xl bg-white p-4 rounded-lg shadow-lg" style={{ maxHeight: '500px', overflowY: 'auto' }}>
        ...
        {verses.map((verse, index) => (
          <p key={index} className="mb-1 text-gray-700"><strong className="text-blue-600">{verse.verseNumber}:</strong> {verse.text}</p>
        ))}
      </div>
    </div>
  );
